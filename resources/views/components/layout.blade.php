...
<div class="container-fluid position-absolute nav-bar p-0">
    <div class="container position-relative" style="z-index: 9;">
        <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5 border-bar border-left border-right border-bottom">
...
<div class="container-fluid  py-3">
    <div class="container">
        <div class="row">
            ...
            {{--                        <h5 style="color: red">Our Office</h5>--}}
            {{--                        <p class="m-0">Jindo Dero Talka Garhi Yasin Larkana</p>--}}
            {{--                    </div>--}}
            {{--                </div>--}}
            {{--            </div>--}}
            ...
            {{--                    <div class="d-flex flex-column">--}}
            {{--                        <h5 style="color: red">Call Us</h5>--}}
            {{--                        <p class="m-0">+447902018704</p>--}}
            {{--                    </div>--}}
            {{--                </div>--}}
            {{--            </div>--}}
        </div>
...
<div class="container-fluid bg-light" style="padding-bottom: 100px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div
                    class="d-flex flex-column align-items-center justify-content-center  h-100 py-5 px-3 rounded" style="background-image:url({{url('/img/start.jpg')}});">
                    ...
                    <div class="containerbtn">
                        <div class="centerbtn1">
                            <a href="https://wa.link/hf4mw2" class="btn btn-primary py-md-3 px-md-5 mt-2 mt-md-4 rounded-pill centerbtn1 shadow-lg"
...
<div class="container-fluid bg-grey text-white py-5 px-sm-3 px-md-5">
    ...
    {{--            &copy; <a class="text-white font-weight-bold" href="/">DesignerArtX</a> Designed by--}}
    {{--            <a class="text-white font-weight-bold" href="#">iTechSoftwares</a>--}}
    {{--        </p>--}}
    {{--    </div>--}}
    {{--</div>--}}
    <!-- Footer End -->
